...
const topicsData =
  [
    {id: 7, topic: 'College Life: Social Justice & Seva'},
    {id: 8, topic: 'Entertainment: Music & Sports'},
    {id: 9, topic: 'Traveling to Punjab: The Land of 5 Rivers'},
    {id: 10, topic: 'Exploring the City'},
  ]

const titleText = 'Punjabi 3 Vocabulary'
