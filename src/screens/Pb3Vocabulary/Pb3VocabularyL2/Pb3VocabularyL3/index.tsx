...
const Pb3VocabularyL3 = ({ route }) => {
  ...
  const onBackPress = useCallback(() => {
    ...
    navigate(ROUTERS.Pb3VocabularyL2);
  }, []);

  // Callback for playing audio
  const playAudio = (item: any) => {
    //console.log('L80 Pb3VocabularyL3()::playAudio() playing: ', item.audioId);
    if (isAudioLooping) {
      ...
      //console.log('L86 Pb3VocabularyL3()::playAudio() playing: ', item.audioId);
  ...
  const loopAudio = (item: any) => {
    if (isAudioLooping) {
      ...
      player.looping = true
      player.play().on('ended', () => {
        //console.log('Pb3VocabularyL3(), audio looping');
      })
    }
  }
...
export default Pb3VocabularyL3;