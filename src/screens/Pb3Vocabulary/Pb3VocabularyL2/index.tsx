...
const Pb3VocabularyL2 = ({ route }) => {
  ...
  const onButtonPress = (item: any) => {
    ...
    navigate(ROUTERS.Pb3VocabularyL3, {titleText, item, topic, selectedWordGroup, selectedWords});
  }

  const showList = (selectedIdx: any) => {
    //console.log('L103 Pb3VocabularyL2(), showList pressed selectedIdx = ', selectedIdx);
...
export default Pb3VocabularyL2;