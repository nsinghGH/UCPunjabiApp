...
const Pb1VocabularyL2 = ({ route }) => {
  ...
  const onButtonPress = (item: any) => {
    ...
    navigate(ROUTERS.Pb1VocabularyL3, {titleText, topic, item, selectedWordGroup, selectedWords});
  }

  const showList = (selectedIdx: any) => {
    //console.log('L89 Pb1VocabularyL2(), showList pressed selectedIdx = ', selectedIdx);
...
export default Pb1VocabularyL2;