...
const topicsData =
  ...
  const titleText = 'Punjabi 1 Vocabulary'
  
  const Pb1Vocabulary = () => {
  let listner: any;

  //console.log('Pb1Vocabulary(), topicsData = ', topicsData)
  ...
  const onButtonPress = (item: any) => {
    //console.log('L67 Pb1Vocabulary, item = ', item)
    navigate(ROUTERS.Pb1VocabularyL2, {item, titleText});
  }
